...
public class MyOrderScreen extends BaseClass {
	...
	public MyOrderScreen(WebDriver driver) {
		this.driver = driver;
	}

	@FindBy(how = How.XPATH, using = "//TABLE[@id='my-orders-table']/TBODY[1]/TR[1]/TD[1]/P[1]")	
	private WebElement	YouHavePlacedNoOrdersP;
	public String textPYouHavePlacedNoOrders() {
		waitForExpectedElement(driver, YouHavePlacedNoOrdersP);		
		String text = YouHavePlacedNoOrdersP.getText();
		return text;
	}

...
public class LoggedInScreen extends BaseClass {
	...
	private WebElement	HelloMalleshwarA;
	public String clkAHelloMalleshwar() {
		waitForExpectedElement(driver, HelloMalleshwarA);		
		String text = HelloMalleshwarA.getText();
		HelloMalleshwarA.click();
		return text;
	}

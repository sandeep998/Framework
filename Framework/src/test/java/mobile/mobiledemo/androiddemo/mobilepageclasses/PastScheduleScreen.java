...
public class PastScheduleScreen extends MobileBase {
	...
	public PastScheduleScreen(AppiumDriver<MobileElement> appiumDriver) {
		this.appiumDriver = appiumDriver;
		PageFactory.initElements(new AppiumFieldDecorator(appiumDriver), this);
	}

	public void LabelSUMMARY() {
		MobileElement SUMMARYLabel = findElementByText("//android.widget.TextView[@text='SUMMARY']");		
		String text = SUMMARYLabel.getText();
		SUMMARYLabel.click();
	}

	public void clkImageViewNextIv() {
		MobileElement NextIvImageView = findElementById("//android.widget.ImageView[@resource-id='co.legion.client.staging:id/nextIv']");		
		NextIvImageView.click();
	}

	public void LabelMore() {
		MobileElement MoreLabel = findElementById("//android.widget.TextView[@resource-id='co.legion.client.staging:id/tabTv']");		
		String text = MoreLabel.getText();
		MoreLabel.click();
	}

...
public class DashboardScreen extends MobileBase {
	...
	public String LabelSchedule() {
		MobileElement ScheduleLabel = findElementByText("//android.widget.TextView[@text='Schedule']");		
		String text = ScheduleLabel.getText();
		ScheduleLabel.click();
		return text;
	}

...
public class ScheduleOverviewScreen extends MobileBase {
	...
	public ScheduleOverviewScreen(AppiumDriver<MobileElement> appiumDriver) {
		this.appiumDriver = appiumDriver;
		PageFactory.initElements(new AppiumFieldDecorator(appiumDriver), this);
	}

	public void LabelMAY22nnMAY28() {
		MobileElement MAY22nnMAY28Label = findElementByText("//android.widget.TextView[@text='MAY 22\n-\nMAY 28']");		
		String text = MAY22nnMAY28Label.getText();
		MAY22nnMAY28Label.click();
	}

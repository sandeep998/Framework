...
public class LoginScreen extends MobileBase {
	...
	public void LabelCancel() {
		MobileElement CancelLabel = findElementById("//android.widget.TextView[@resource-id='co.legion.client.staging:id/cancelTV']");		
		String text = CancelLabel.getText();
		CancelLabel.click();
	}

	public void fillInputTextUsername(String varInputValue) {
		MobileElement UsernameInputText = findElementById("//android.widget.EditText[@resource-id='co.legion.client.staging:id/usernameET']");
		UsernameInputText.sendKeys(varInputValue);
	}

	public void fillInputTextPasswordEditText(String varInputValue) {
		MobileElement PasswordEditTextInputText = findElementById("//android.widget.EditText[@resource-id='co.legion.client.staging:id/passwordEditText']");
		PasswordEditTextInputText.sendKeys(varInputValue);
	}

	public void LabelLogin() {
		MobileElement LoginLabel = findElementById("//android.widget.TextView[@resource-id='co.legion.client.staging:id/login']");		

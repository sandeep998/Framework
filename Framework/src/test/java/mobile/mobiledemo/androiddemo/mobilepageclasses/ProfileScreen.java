...
public class ProfileScreen extends MobileBase {
	...
	public ProfileScreen(AppiumDriver<MobileElement> appiumDriver) {
		this.appiumDriver = appiumDriver;
		PageFactory.initElements(new AppiumFieldDecorator(appiumDriver), this);
	}

	public void LabelProfile() {
		MobileElement ProfileLabel = findElementById("//android.widget.TextView[@resource-id='co.legion.client.staging:id/profile']");		
		String text = ProfileLabel.getText();
		ProfileLabel.click();
	}

...
public class AlertScreen extends MobileBase {
	...
	public AlertScreen(AppiumDriver<MobileElement> appiumDriver) {
		this.appiumDriver = appiumDriver;
		PageFactory.initElements(new AppiumFieldDecorator(appiumDriver), this);
	}

	public String clkButtonOK() {
		MobileElement OKButton = findElement("//XCUIElementTypeButton[@name='OK']");		

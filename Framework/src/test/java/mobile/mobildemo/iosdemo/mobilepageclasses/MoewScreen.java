...
public class MoewScreen extends MobileBase {
	...
	public MoewScreen(AppiumDriver<MobileElement> appiumDriver) {
		this.appiumDriver = appiumDriver;
		PageFactory.initElements(new AppiumFieldDecorator(appiumDriver), this);
	}

	public void clkButtonMore() {
		MobileElement MoreButton = findElement("//XCUIElementTypeButton[@name='••• More']");		

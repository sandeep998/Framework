...
public class JoinNowScreen extends MobileBase {
	...
	public JoinNowScreen(AppiumDriver<MobileElement> appiumDriver) {
		this.appiumDriver = appiumDriver;
		PageFactory.initElements(new AppiumFieldDecorator(appiumDriver), this);
	}

	public void clkButtonJOINNOW() {
		MobileElement JOINNOWButton = findElementById("//android.widget.Button[@resource-id='loyalty-onboarding-intro-register']");		
		String text = JOINNOWButton.getText();
		JOINNOWButton.click();
	}
